...
local CheckVersion = function()
    ...
    SetTimeout(1000, function()
        PerformHttpRequest('https://api.github.com/repos/NeonOceAu/' ..resourceName.. '/releases/latest', function(status, response)
            ...
            if latestVersion ~= currentVersion then
                ...
                print('^1['..resourceName..'] ^3Download the latest release from https://github.com/NeonOceAu/'..resourceName..'/releases^0')
